...
private String name;
  ...
  public Hero(String name, int intelligence, int agility, int strength) {
    ...
    items[0] = new Item("Attack",(int)(Math.random()*10+2),0,(int)(Math.random()*10+10));
    items[1] = new Item("Protect", 0, (int)(Math.random()*10+2),(int)(Math.random()*10+10));
    items[2] = new Item ("Additional", (int)(Math.random()*20),(int)(Math.random()*20),(int)(Math.random()*10+10));
  ...
  public abstract int getNewStrike();
